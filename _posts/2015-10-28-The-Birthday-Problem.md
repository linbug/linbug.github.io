...
$$P(A) = \frac{number of outcomes possible under A}{number of total possible outcomes}
...
###The numerator: number of outcomes possible under A
...
$$\frac{365\centerdot 364\centerdot 363 \cdots (365 - k + 1)}{365^k}$$
...
I exported all 340 of my facebook friend's birthdays to .ics format, and then loaded this into pandas. Some munging was needed but it's not very interesting; if you care about it you can see the ipython notebook [here](http://nbviewer.ipython.org/github/linbug.github.io/master/_downloads/birthdays.ipynb). 
...
<img src="https://raw.githubusercontent.com/linbug/linbug.github.io/master/_downloads/fb_probabilities.png" title="facebook friends' birthdays" style="margin: 0 auto;"/>
...
My ipython notebook for these analyses are available [here](http://nbviewer.ipython.org/github/linbug.github.io/master/_downloads/birthdays.ipynb). If you're taking this course, I can recommend William Chen's great [cheat sheet](https://datastories.quora.com/The-Only-Probability-Cheatsheet-Youll-Ever-Need). Thanks for reading!
